...
export const CustomerSidebar: React.FC<CustomerSidebarProps> = ({ onClose }) => {
  ...
  const navItems = [
    ...
    { label: 'Discover Providers', path: '/customer/discover', icon: Compass },
    ...
    <aside className="w-64 bg-zinc-950 border-r border-zinc-850 flex flex-col min-h-screen text-zinc-300 font-sans">
      ...
      <div className="p-6 border-b border-zinc-850 flex items-center gap-3">
        ...
        <div>
          ...
          <span className="text-[10px] text-zinc-555 font-medium uppercase tracking-wider">Customer Portal</span>
        </div>
      </div>
